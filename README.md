...
- 支持 PDF、图片、原始打印指令（Raw Commands），以及通过[内置转换器转 PDF](https://docs.rs/office2pdf/latest/office2pdf) 后打印的 Office(.docx/.xlsx/.pptx) 文件
- 原始打印指令使用内联 `data_base64`，PrintBridge 不解析 ESC/POS、ZPL、EPL、PCL、PostScript 等设备语言
