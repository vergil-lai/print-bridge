...
This project includes or may distribute third-party components under their own
licenses.

## SumatraPDF

PrintBridge includes the Windows portable SumatraPDF executable for PDF
printing:
...
- Bundled version: 3.6.1 64-bit portable
